...
commands_file = 'C:\Users\apuglielli\Documents\MATLAB\EE290C\matlab\chisel_configs\configTrainBusCmds.txt';
commands_file_id = fopen(commands_file,'wt');
data_file = 'C:\Users\apuglielli\Documents\MATLAB\EE290C\matlab\chisel_configs\receiveData.txt';
data_file_id = fopen(data_file,'wt');
symbols_file = 'C:\Users\apuglielli\Documents\MATLAB\EE290C\matlab\chisel_configs\decodedData.txt';
...
commands_header = [0 0 Ntx 1 1 Nrx 2 2 size(trainIn,2) 3 3 0 4 4 SNR_lin];
